...
struct ComputeSimplitigsData##type {                                                                                   \
...
void ComputeSimplitigsThread##type(void *arg, long i, int _) {                                                         \
    auto *data = (ComputeSimplitigsData##type *) arg;                                                                  \
