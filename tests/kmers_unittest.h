...
namespace {
    ...
    TEST(KMers, ReverseComplement128) {
        struct TestCase {
            kmer128_t input;
            int k;
            kmer128_t wantResult;
        };
        std::vector<TestCase> tests = {
                {0b1001LL, 2, 0b1001LL},
                {0b101111LL, 3, 0b000001LL},
                {0b11LL, 1, 0b00LL},
                {0b11111111'01111111'11111111'11111111'11111111'11111111'11111111'11111110LL, 32, 0b010000'00000000'00000000'00000000'00000000'00000000'00000000'1000000000LL },
                {(kmer128_t (0b11111111'01111111'11111111'11111111'11111111'11111111'11111111'11111110LL) << 64) + kmer128_t (0b10111111'01111111'11111111'11111111'11111111'11111111'11111111'11111110LL) ,
                 64, (kmer128_t (0b010000'00000000'00000000'00000000'00000000'00000000'00000000'1000000001LL)<<64 ) + kmer128_t (0b010000'00000000'00000000'00000000'00000000'00000000'00000000'1000000000LL) },
        };

        for (auto t: tests) {
            kmer128_t gotResult = ReverseComplement(t.input, t.k);

            EXPECT_EQ(t.wantResult, gotResult);
        }
    }

    TEST(KMers, ReverseComplement256) {
        struct TestCase {
            kmer256_t input;
            int k;
            kmer256_t wantResult;
        };
        std::vector<TestCase> tests = {
                {0b1001LL, 2, 0b1001LL},
                {0b101111LL, 3, 0b000001LL},
        ...
        for (auto t: tests) {
        kmer256_t gotResult = ReverseComplement(t.input, t.k);
